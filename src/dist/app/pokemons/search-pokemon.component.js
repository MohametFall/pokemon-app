...
var PokemonSearchComponent = (function () {
    ...
    PokemonSearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pokemons$ = this.searchTerms.pipe(operators_1.debounceTime(300), operators_1.distinctUntilChanged(), operators_1.switchMap(function (term) { return _this.pokemonsService.searchPokemons(term); }));
    };
