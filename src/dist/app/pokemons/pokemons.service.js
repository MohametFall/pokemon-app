...
var PokemonsService = (function () {
    ...
    PokemonsService.prototype.isPokemon = function () {
    ...
    PokemonsService.prototype.searchPokemons = function (term) {
        ...
        return this.http.get("api/pokemons/?nom=" + term).pipe(operators_1.tap(function (_) { return _this.log("found pokemons matching \"" + term + "\""); }), operators_1.catchError(this.handleError('searchPokemons', [])));
    };
